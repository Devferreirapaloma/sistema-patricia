...
<div id="box_topo">
 ...
 <div id="mostra_login">
  <h1><strong>Seja Bem Vindo <i><?php echo @$nome; ?> </i>- Seu código é: <?php echo @$code; ?></strong> <strong><a href="../config.php?pg=sair">Sair</a></strong></h1>
 </div><!-- mostra_login -->
</div><!-- box_topo -->
  ...
  <ul>
   ...
   <li><a href="">RELATÓRIOS</a>
    ...
    <li><a href="relatorios.php?tipo=alunos&s=<?php echo base64_encode("SELECT * FROM estudantes WHERE nome != ''"); ?>">Alunos</a></li>
     <li><a href="relatorios.php?tipo=professores&s=<?php echo base64_encode("SELECT * FROM disciplinas"); ?>">Professores</a></li>
